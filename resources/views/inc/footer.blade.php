  ...
  <div class="footer-main">
    <div class="container">
      <div class="row">
        ...
        <div class="col-sm-6 col-md-3">
          <div class="footer-links">
            <h3 class="footer-brand mb-2">be-Rojgar</h3>
            <div class="footer-link-list">
             <a href="#" class="footer-links"><i class="fas fa-compass"></i> Lekhnath,Pokhara-4200,Nepal</a>
             ...
             <a href="mailto:info@joblister.com" class="footer-links"><i class="fas fa-envelope"></i> info@be-Rojgar.com</a>
